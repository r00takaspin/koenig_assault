# encoding: UTF-8
# RailsAdmin config file. Generated on March 13, 2013 23:26
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Koenig Assault', 'Admin']
  ...
  # config.excluded_models = ['ArchivePost']

  # Include specific models (exclude the others):
  # config.included_models = ['ArchivePost']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your archive_post.rb model definition
  ...
  #     configure :preview_content, :string 
  #     configure :detail_content, :string 
